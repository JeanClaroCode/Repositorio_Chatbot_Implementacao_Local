...
class ActionFiltrarEndereco(Action):
    ...
    def run(
        ...
        # Atualize a URL da API Flask com a nova URL do Ngrok
        flask_api_url = "https://c848895f0727.ngrok.app/api/unidades_de_saude"
        
        # Parâmetros para a requisição GET
        params = {
            "abrangencia": cidade,
            "uf": estado,
            "isFulltime": is_full_time_value
        }

        try:
            # Faça a chamada à API Flask usando a URL pública do Ngrok
